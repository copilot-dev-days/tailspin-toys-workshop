...
Antes de comenzar con el laboratorio, hay algunas tareas que necesitas completar para tener todo listo. Primero debes crear tu propia copia del repositorio, y luego elegir si trabajar en un [codespace][codespaces] o clonando tu propio repositorio localmente.
...
2. Crea tu propia copia del repositorio seleccionando el botón **Use this template** en la página del repositorio del laboratorio. Luego selecciona **Create a new repository**.
    ...
    ![Botón Use this template](../images/0-use-template.png)
...
3. Si estás completando el taller como parte de un evento dirigido por GitHub o Microsoft, sigue las instrucciones proporcionadas por los mentores. De lo contrario, puedes crear el nuevo repositorio en una organización donde tengas acceso a Copilot.
    ...
    ![Configuración del template del repositorio](../images/0-repository-settings.png)
...
Ahora que has creado tu propio repositorio, elige una de las siguientes opciones:

### Opción A: Crear un Codespace para tu Repositorio (recomendado)

[GitHub Codespaces][codespaces] es un entorno de desarrollo basado en la nube que te permite escribir, ejecutar y depurar código directamente en tu navegador. Proporciona un IDE con todas las funcionalidades, con soporte para múltiples lenguajes de programación, extensiones y herramientas.

1. Navega a tu repositorio recién creado.
2. Selecciona el botón verde **Code**.

    ![Selecciona el botón Code](../images/0-code-button.png)

3. Selecciona la pestaña **Codespaces** y selecciona el botón **+** para crear un nuevo Codespace.

    ![Crear un nuevo codespace](../images/0-create-codespace.png)
...
### Opción B: Clonar tu Repositorio localmente

Si prefieres trabajar localmente en lugar de en un codespace, clona tu propio repositorio y ábrelo en VS Code:
...
> [!IMPORTANT]
> Si elegiste la Opción A, volverás al codespace en un ejercicio futuro. Por el momento, déjalo abierto en una pestaña de tu navegador.
...
¡Felicidades, has creado una copia del repositorio del laboratorio y seleccionado tu entorno de desarrollo!

## Recursos

- [Descripción general de GitHub Codespaces][codespaces]
- [Crear un repositorio a partir de un template][template-repository]
