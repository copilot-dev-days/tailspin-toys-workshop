...
class TestPublishersRoutes(unittest.TestCase):
    ...
    TEST_DATA: Dict[str, Any] = {
        "publishers": [
            {"name": "DevGames Inc", "description": "Makers of development-themed games"},
            {"name": "Scrum Masters", "description": "Agile methodology gaming specialists"},
            {"name": "Code Crusaders", "description": "Programming adventure game creators"}
        ]
    }
